 ...
 */
@Composable
public fun rememberPullToRefreshState(
...
public class PullToRefreshState(
     ...
     */
    public var isPullInProgress: Boolean by mutableStateOf(false)
        internal set

    /**
     * Whether this [PullToRefreshState] is currently animating to its resting position or not.
     */
    public val isResting: Boolean get() = _contentOffset.isRunning && !isRefreshing

    /**
     * The current offset for the content, in pixels.
     */
    public val contentOffset: Float get() = _contentOffset.value
